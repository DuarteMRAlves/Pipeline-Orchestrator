...
public class YamlMergeArchitectureTest {
    ...
    private static final String CONFIG_FILE = "src/test/resources/yaml/merge_architecture.yaml";
    ...
    private void assertLinks(Set<LinkInformation> links) {
        for (LinkInformation link : links) {
            ...
            if (sourceStage.equals(NAME_1) && targetStage.equals(NAME_2)) {
            ...
            else if (sourceStage.equals(NAME_2) && targetStage.equals(NAME_4)) {
                ...
                throw new RuntimeException(
                        String.format("Unknown link '%s'->'%s'", sourceStage, targetStage));
            }
        }
    }
}
